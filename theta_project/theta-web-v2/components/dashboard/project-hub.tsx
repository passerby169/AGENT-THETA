  ...
  return (
    <div className="min-h-full w-full max-w-full overflow-x-hidden p-4 sm:p-6 lg:p-8">
      <div className="w-full max-w-7xl mx-auto">
        {/* 顶部一行：标题 + 批量管理 + 新建 */}
        <div className="flex flex-wrap sm:flex-nowrap items-center justify-between gap-2 sm:gap-4 mb-6">
        ...
        {!isLoading && (
          <div
            className={cn("grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 relative items-stretch", batchMode && "cursor-crosshair")}
          >
              ...
              return (
                ...
                >
                  ...
                  <CardContent className="p-4 relative h-[167px] flex flex-col min-w-0">
                    ...
                    {/* 标题和状态 */}
                    <div className={`flex items-start justify-between gap-2 mb-3 ${onDeleteProject ? "pr-7" : ""} ${canSelect ? "pl-7" : ""}`}>
